...
public class MainJava2D extends JPanel {
    ...
    public void paint(Graphics g1) {
        ...
        g.setStroke(new BasicStroke(1)); // use wide lines
        ...
        Font bigfont = // a scaled up version
                font.deriveFont(AffineTransform.getScaleInstance(13.0, 13.0));
    ...
    public static void main(String[] a) {
        ...
        f.setContentPane(new MainJava2D());
        f.setSize(MainJava2D.WIDTH,MainJava2D.HEIGHT);
        f.setVisible(true);
    }
}
